const anzhiyu = {
    ...
    catalogActive: function () {
        ...
        if ($list) {
            ...
            const catalogListItems =
                $list.querySelectorAll(".catalog-list-item");
    ...
    changeTimeInAlbumDetail: function () {
        document.querySelector("#album_detail") &&
            document
                .querySelectorAll("#album_detail time")
                .forEach(function (e) {
                    var t = e,
                        datetime = t.getAttribute("datetime");
                    (t.innerText = anzhiyu.diffDate(datetime, true)),
    ...
    musicToggle: function (changePaly = true) {
        ...
        let msgPlay =
            '<i class="anzhiyufont anzhiyu-icon-play"></i><span>播放音樂</span>';
        let msgPause =
            '<i class="anzhiyufont anzhiyu-icon-pause"></i><span>暫停音樂</span>';
    ...
    playMusic(songs) {
        ...
        if (!selectRandomSong.includes(randomSong.name)) {
            ...
            if (!songFound) {
                ...
                if (palyMusicIndex != -1)
                    metingAplayer.list.switch(palyMusicIndex);
            }
        }
    ...
    hideTodayCard: function () {
        if (document.getElementById("todayCard")) {
            ...
            const recentPostItems =
                topGroup.querySelectorAll(".recent-post-item");
    ...
    addEventListenerMusic: function () {
        ...
        const anMusicBtnGetSong =
            anMusicPage.querySelector("#anMusicBtnGetSong");
        const anMusicRefreshBtn =
            anMusicPage.querySelector("#anMusicRefreshBtn");
        const anMusicSwitchingBtn =
            anMusicPage.querySelector("#anMusicSwitching");
        const metingAplayer = anMusicPage.querySelector("meting-js").aplayer;
        //初始化音量
        ...
        anMusicBtnGetSong.addEventListener("click", () => {
            if (changeMusicListFlag) {
                const anMusicPage = document.getElementById("anMusic-page");
                const metingAplayer =
                    anMusicPage.querySelector("meting-js").aplayer;
                const allAudios = metingAplayer.list.audios;
                const randomIndex = Math.floor(
                    Math.random() * allAudios.length
                );
                // 隨機播放一首
...
const anzhiyuPopupManager = {
    ...
    popupShow(title, tip, url, duration) {
        ...
        const windowContent = popupWindow.querySelector(
